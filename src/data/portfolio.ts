...
export const portfolioData = {
  ...
  title: "Full Stack Software Developer & Graphic Designer",
  location: "Brahmapur, Odisha, India",
  email: "jyotiranjan.sahoo.cse.2022@nist.edu",
  phone: "+91 8114325023",
  intro:
    "I build scalable web applications and AI-powered SaaS products with a strong focus on performance, secure architecture, and premium user experience.",
  about:
    "Full-stack developer experienced with Next.js, React, TypeScript, Node.js, and PostgreSQL. I design and ship production-ready systems including RBAC auth, payment workflows, cloud storage integrations, and robust AI-assisted product experiences.",
  socials: {
    ...
    email: "mailto:jyotiranjan.sahoo.cse.2022@nist.edu",
  },
  skills: {
...
export const projects: Project[] = [
  ...
  {
    slug: "social-media-ghostwriter",
    title: "Social Media Ghostwriter",
    period: "2025",
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "OpenRouter AI", "Vercel"],
    summary:
      "A GenAI micro-SaaS that turns raw ideas into LinkedIn posts, Twitter threads, and newsletters.",
    highlights: [
      "Delivered 6 AI content generation tools for structured multi-format output.",
      "Engineered backend parsing to recover malformed LLM JSON responses.",
      "Optimized serverless architecture for stable AI API integrations.",
    ],
    liveDemo: "#",
    image: "/assets/projects/ghostwriter-cover.jpg",
    galleryImages: [
      "/assets/projects/ghostwriter-1.jpg",
      "/assets/projects/ghostwriter-2.jpg",
      "/assets/projects/ghostwriter-3.jpg",
    ],
  },
  {
    slug: "autonomous-uav-navigation",
    title: "Autonomous UAV Navigation using Liquid Neural Networks",
    period: "2025",
    stack: ["Python", "Machine Learning", "AirSim", "PX4", "WSL"],
    summary:
      "An LNN-based autonomous navigation system optimized for out-of-distribution robustness.",
    highlights: [
      "Built complete training and evaluation pipeline for robust flight behavior.",
      "Improved latency and resilience compared to baseline LSTM approach.",
      "Handled data collection and preprocessing workflows across simulation environments.",
    ],
    liveDemo: "#",
    image: "/assets/projects/uav-cover.jpg",
    galleryImages: [
      "/assets/projects/uav-1.jpg",
      "/assets/projects/uav-2.jpg",
      "/assets/projects/uav-3.jpg",
    ],
  },
  {
  ...
  },
  {
    ...
    liveDemo: "https://packmax-app.vercel.app/",
